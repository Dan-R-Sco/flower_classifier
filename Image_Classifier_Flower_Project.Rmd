...
```{python colab_type=code, executionInfo={'elapsed': 661, 'status': 'ok', 'timestamp': 1544279526456, 'user': {'displayName': 'Boris Kushnarev', 'photoUrl': 'https://lh5.googleusercontent.com/-7Z8h64--40c/AAAAAAAAAAI/AAAAAAAAajw/pfM0Ql97dVY/s64/photo.jpg', 'userId': '10599252230475805342'}, 'user_tz': -360}, id=BRKVtVxurOx_, outputId=7e82fddb-b4e6-4bf1-9bf0-6ea10d7ca2b8, colab={'base_uri': 'https://localhost:8080/', 'height': 119}}
...
```{python colab_type=code, executionInfo={'elapsed': 1318, 'status': 'ok', 'timestamp': 1544280769475, 'user': {'displayName': 'Boris Kushnarev', 'photoUrl': 'https://lh5.googleusercontent.com/-7Z8h64--40c/AAAAAAAAAAI/AAAAAAAAajw/pfM0Ql97dVY/s64/photo.jpg', 'userId': '10599252230475805342'}, 'user_tz': -360}, id=jseTRbj5b2Hd, outputId=7f3f903a-8546-4544-d101-1deaff729de0, colab={'base_uri': 'https://localhost:8080/', 'height': 285}}
...
```{python colab_type=code, id=d57re_y0O2DJ, colab={}}
