...
```{python colab_type=code, executionInfo={'elapsed': 32923, 'status': 'ok', 'timestamp': 1544252783541, 'user': {'displayName': 'Boris Kushnarev', 'photoUrl': 'https://lh5.googleusercontent.com/-7Z8h64--40c/AAAAAAAAAAI/AAAAAAAAajw/pfM0Ql97dVY/s64/photo.jpg', 'userId': '10599252230475805342'}, 'user_tz': -360}, id=ZyVGourE6PQX, outputId=8cc5f747-6ece-4e90-e8cd-d485df12f9df, colab={'base_uri': 'https://localhost:8080/', 'height': 54}}
# http://pytorch.org/
...
```{python colab_type=code, executionInfo={'elapsed': 6591, 'status': 'ok', 'timestamp': 1544266210184, 'user': {'displayName': 'Boris Kushnarev', 'photoUrl': 'https://lh5.googleusercontent.com/-7Z8h64--40c/AAAAAAAAAAI/AAAAAAAAajw/pfM0Ql97dVY/s64/photo.jpg', 'userId': '10599252230475805342'}, 'user_tz': -360}, id=1deJPK6pyX-3, outputId=fdb1c938-a144-4c5f-f901-276dacba2920, colab={'base_uri': 'https://localhost:8080/', 'height': 207}}
...
```{python colab_type=code, executionInfo={'elapsed': 51084, 'status': 'ok', 'timestamp': 1544252801727, 'user': {'displayName': 'Boris Kushnarev', 'photoUrl': 'https://lh5.googleusercontent.com/-7Z8h64--40c/AAAAAAAAAAI/AAAAAAAAajw/pfM0Ql97dVY/s64/photo.jpg', 'userId': '10599252230475805342'}, 'user_tz': -360}, id=JMjhrWBd6Nv-, outputId=bcca53a2-7ba0-49c1-d2fc-617c98860636, colab={'base_uri': 'https://localhost:8080/', 'height': 224}}
#download a flower dataset
!wget https://s3.amazonaws.com/content.udacity-data.com/courses/nd188/flower_data.zip
  
```

```{python colab_type=code, executionInfo={'elapsed': 56680, 'status': 'ok', 'timestamp': 1544252807324, 'user': {'displayName': 'Boris Kushnarev', 'photoUrl': 'https://lh5.googleusercontent.com/-7Z8h64--40c/AAAAAAAAAAI/AAAAAAAAajw/pfM0Ql97dVY/s64/photo.jpg', 'userId': '10599252230475805342'}, 'user_tz': -360}, id=WhGh5ZXA6qE1, outputId=8ec536c4-5714-4ce9-e3fa-c505acf5db62, colab={'base_uri': 'https://localhost:8080/', 'height': 128843}}
...
```{python colab_type=code, executionInfo={'elapsed': 872, 'status': 'ok', 'timestamp': 1544254929497, 'user': {'displayName': 'Boris Kushnarev', 'photoUrl': 'https://lh5.googleusercontent.com/-7Z8h64--40c/AAAAAAAAAAI/AAAAAAAAajw/pfM0Ql97dVY/s64/photo.jpg', 'userId': '10599252230475805342'}, 'user_tz': -360}, id=18eI5i6OHY1e, outputId=f4064d89-606a-4fa5-92af-fe965a128243, colab={'base_uri': 'https://localhost:8080/', 'height': 8571}}
...
```{python colab_type=code, executionInfo={'elapsed': 644, 'status': 'ok', 'timestamp': 1544254937899, 'user': {'displayName': 'Boris Kushnarev', 'photoUrl': 'https://lh5.googleusercontent.com/-7Z8h64--40c/AAAAAAAAAAI/AAAAAAAAajw/pfM0Ql97dVY/s64/photo.jpg', 'userId': '10599252230475805342'}, 'user_tz': -360}, id=9xpCxi9fHbBV, outputId=1101ecbc-69b4-4173-b059-d0fc32b0af1f, colab={'base_uri': 'https://localhost:8080/', 'height': 102}}
...
```{python colab_type=code, executionInfo={'elapsed': 632, 'status': 'ok', 'timestamp': 1544254945535, 'user': {'displayName': 'Boris Kushnarev', 'photoUrl': 'https://lh5.googleusercontent.com/-7Z8h64--40c/AAAAAAAAAAI/AAAAAAAAajw/pfM0Ql97dVY/s64/photo.jpg', 'userId': '10599252230475805342'}, 'user_tz': -360}, id=JskcQAKAJNRS, outputId=ad035390-2bcb-4d1b-e334-597fbc6835ab, colab={'base_uri': 'https://localhost:8080/', 'height': 34}}
...
```{python colab_type=code, executionInfo={'elapsed': 611, 'status': 'ok', 'timestamp': 1544254982405, 'user': {'displayName': 'Boris Kushnarev', 'photoUrl': 'https://lh5.googleusercontent.com/-7Z8h64--40c/AAAAAAAAAAI/AAAAAAAAajw/pfM0Ql97dVY/s64/photo.jpg', 'userId': '10599252230475805342'}, 'user_tz': -360}, id=wjsKqP_axLgc, outputId=bcc4aa5d-3b3a-47e4-e19b-de80006f7f57, colab={'base_uri': 'https://localhost:8080/', 'height': 8605}}
model
```

### Train the network

```{python colab_type=code, executionInfo={'elapsed': 122206, 'status': 'ok', 'timestamp': 1544255144748, 'user': {'displayName': 'Boris Kushnarev', 'photoUrl': 'https://lh5.googleusercontent.com/-7Z8h64--40c/AAAAAAAAAAI/AAAAAAAAajw/pfM0Ql97dVY/s64/photo.jpg', 'userId': '10599252230475805342'}, 'user_tz': -360}, id=zYu3cZheQGSN, outputId=90f00b6f-b46e-405d-f0ea-6ba215a0f286, colab={'base_uri': 'https://localhost:8080/', 'height': 71}}
...
```{python colab_type=code, executionInfo={'elapsed': 741, 'status': 'ok', 'timestamp': 1544255555711, 'user': {'displayName': 'Boris Kushnarev', 'photoUrl': 'https://lh5.googleusercontent.com/-7Z8h64--40c/AAAAAAAAAAI/AAAAAAAAajw/pfM0Ql97dVY/s64/photo.jpg', 'userId': '10599252230475805342'}, 'user_tz': -360}, id=3o4knBNwu_ac, outputId=a081d25c-9638-486e-c879-c4c0c6727c6b, colab={'base_uri': 'https://localhost:8080/', 'height': 71}}
...
```{python colab_type=code, executionInfo={'status': 'ok', 'timestamp': 1544279526456, 'user_tz': -360, 'elapsed': 661, 'user': {'displayName': 'Boris Kushnarev', 'photoUrl': 'https://lh5.googleusercontent.com/-7Z8h64--40c/AAAAAAAAAAI/AAAAAAAAajw/pfM0Ql97dVY/s64/photo.jpg', 'userId': '10599252230475805342'}}, id=BRKVtVxurOx_, outputId=7e82fddb-b4e6-4bf1-9bf0-6ea10d7ca2b8, colab={'base_uri': 'https://localhost:8080/', 'height': 119}}
...
```{python colab_type=code, id=jseTRbj5b2Hd, colab={'base_uri': 'https://localhost:8080/', 'height': 285}, outputId=7f3f903a-8546-4544-d101-1deaff729de0, executionInfo={'status': 'ok', 'timestamp': 1544280769475, 'user_tz': -360, 'elapsed': 1318, 'user': {'displayName': 'Boris Kushnarev', 'photoUrl': 'https://lh5.googleusercontent.com/-7Z8h64--40c/AAAAAAAAAAI/AAAAAAAAajw/pfM0Ql97dVY/s64/photo.jpg', 'userId': '10599252230475805342'}}}
...
```{python id=d57re_y0O2DJ, colab_type=code, colab={}}
