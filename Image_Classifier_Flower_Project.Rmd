...
```{python colab_type=code, executionInfo={'elapsed': 1039, 'status': 'ok', 'timestamp': 1544156165981, 'user': {'displayName': 'Boris Kushnarev', 'photoUrl': 'https://lh5.googleusercontent.com/-7Z8h64--40c/AAAAAAAAAAI/AAAAAAAAajw/pfM0Ql97dVY/s64/photo.jpg', 'userId': '10599252230475805342'}, 'user_tz': -360}, id=Ni6OGZ2y5qek, outputId=3be463f1-7593-463f-d204-474bf50731a4, colab={'base_uri': 'https://localhost:8080/', 'height': 34}}
# %autosave 0
```
...
```{python colab_type=code, id=ZyVGourE6PQX, colab={}}
# http://pytorch.org/
...
```{python colab_type=code, executionInfo={'elapsed': 9372, 'status': 'ok', 'timestamp': 1544156216656, 'user': {'displayName': 'Boris Kushnarev', 'photoUrl': 'https://lh5.googleusercontent.com/-7Z8h64--40c/AAAAAAAAAAI/AAAAAAAAajw/pfM0Ql97dVY/s64/photo.jpg', 'userId': '10599252230475805342'}, 'user_tz': -360}, id=JMjhrWBd6Nv-, outputId=45d5cf08-a6e3-4bd6-d725-73e3ebd4b442, colab={'base_uri': 'https://localhost:8080/', 'height': 226}}
...
```{python id=18eI5i6OHY1e, colab_type=code, colab={'base_uri': 'https://localhost:8080/', 'height': 8677}, outputId=aa9e7329-fa87-465d-d7a8-7d6b24069bef, executionInfo={'status': 'ok', 'timestamp': 1544160135977, 'user_tz': -360, 'elapsed': 2317, 'user': {'displayName': 'Boris Kushnarev', 'photoUrl': 'https://lh5.googleusercontent.com/-7Z8h64--40c/AAAAAAAAAAI/AAAAAAAAajw/pfM0Ql97dVY/s64/photo.jpg', 'userId': '10599252230475805342'}}}
...
```{python id=9xpCxi9fHbBV, colab_type=code, colab={'base_uri': 'https://localhost:8080/', 'height': 120}, outputId=3bbbe978-595c-4fa3-ff29-411e3feba155, executionInfo={'status': 'ok', 'timestamp': 1544160626726, 'user_tz': -360, 'elapsed': 728, 'user': {'displayName': 'Boris Kushnarev', 'photoUrl': 'https://lh5.googleusercontent.com/-7Z8h64--40c/AAAAAAAAAAI/AAAAAAAAajw/pfM0Ql97dVY/s64/photo.jpg', 'userId': '10599252230475805342'}}}
...
```{python id=JskcQAKAJNRS, colab_type=code, colab={}}
