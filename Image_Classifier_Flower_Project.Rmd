...
```{python colab_type=code, id=ZyVGourE6PQX, colab={'base_uri': 'https://localhost:8080/', 'height': 54}, outputId=52ec560e-a855-446e-cced-024d63fb3eee, executionInfo={'status': 'ok', 'timestamp': 1544170642157, 'user_tz': -360, 'elapsed': 34688, 'user': {'displayName': 'Boris Kushnarev', 'photoUrl': 'https://lh5.googleusercontent.com/-7Z8h64--40c/AAAAAAAAAAI/AAAAAAAAajw/pfM0Ql97dVY/s64/photo.jpg', 'userId': '10599252230475805342'}}}
# http://pytorch.org/
...
```{python id=1deJPK6pyX-3, colab_type=code, colab={'base_uri': 'https://localhost:8080/', 'height': 188}, outputId=8dc420b0-82f6-481f-e1b2-7cce4830edaa, executionInfo={'status': 'ok', 'timestamp': 1544171578866, 'user_tz': -360, 'elapsed': 7867, 'user': {'displayName': 'Boris Kushnarev', 'photoUrl': 'https://lh5.googleusercontent.com/-7Z8h64--40c/AAAAAAAAAAI/AAAAAAAAajw/pfM0Ql97dVY/s64/photo.jpg', 'userId': '10599252230475805342'}}}
...
```{python colab_type=code, executionInfo={'status': 'ok', 'timestamp': 1544170718582, 'user_tz': -360, 'elapsed': 6987, 'user': {'displayName': 'Boris Kushnarev', 'photoUrl': 'https://lh5.googleusercontent.com/-7Z8h64--40c/AAAAAAAAAAI/AAAAAAAAajw/pfM0Ql97dVY/s64/photo.jpg', 'userId': '10599252230475805342'}}, id=JMjhrWBd6Nv-, outputId=195ab5ac-d38b-45d8-cf5a-4e472bed8004, colab={'base_uri': 'https://localhost:8080/', 'height': 206}}
...
```{python colab_type=code, id=jFHX9AXE95Zg, colab={'base_uri': 'https://localhost:8080/', 'height': 216}, outputId=8b5371f4-27ca-4c54-e057-b0c7d616d2f3, executionInfo={'status': 'error', 'timestamp': 1544170829121, 'user_tz': -360, 'elapsed': 657, 'user': {'displayName': 'Boris Kushnarev', 'photoUrl': 'https://lh5.googleusercontent.com/-7Z8h64--40c/AAAAAAAAAAI/AAAAAAAAajw/pfM0Ql97dVY/s64/photo.jpg', 'userId': '10599252230475805342'}}}
import json
...
```{python colab_type=code, executionInfo={'status': 'ok', 'timestamp': 1544170842261, 'user_tz': -360, 'elapsed': 1611, 'user': {'displayName': 'Boris Kushnarev', 'photoUrl': 'https://lh5.googleusercontent.com/-7Z8h64--40c/AAAAAAAAAAI/AAAAAAAAajw/pfM0Ql97dVY/s64/photo.jpg', 'userId': '10599252230475805342'}}, id=18eI5i6OHY1e, outputId=2564ab91-1125-47f7-8c2c-e999111c72fe, colab={'base_uri': 'https://localhost:8080/', 'height': 8677}}
...
```{python colab_type=code, executionInfo={'status': 'ok', 'timestamp': 1544170851180, 'user_tz': -360, 'elapsed': 604, 'user': {'displayName': 'Boris Kushnarev', 'photoUrl': 'https://lh5.googleusercontent.com/-7Z8h64--40c/AAAAAAAAAAI/AAAAAAAAajw/pfM0Ql97dVY/s64/photo.jpg', 'userId': '10599252230475805342'}}, id=9xpCxi9fHbBV, outputId=2e82166d-af6e-4448-c739-19cf355379a5, colab={'base_uri': 'https://localhost:8080/', 'height': 103}}
...
```{python colab_type=code, id=JskcQAKAJNRS, colab={'base_uri': 'https://localhost:8080/', 'height': 34}, outputId=eacc594d-0845-4761-e8f5-c38208320e7c, executionInfo={'status': 'ok', 'timestamp': 1544172234024, 'user_tz': -360, 'elapsed': 694, 'user': {'displayName': 'Boris Kushnarev', 'photoUrl': 'https://lh5.googleusercontent.com/-7Z8h64--40c/AAAAAAAAAAI/AAAAAAAAajw/pfM0Ql97dVY/s64/photo.jpg', 'userId': '10599252230475805342'}}}
...
```{python id=VpmRqZ39PLhH, colab_type=code, colab={}}
learning_rate = 0.003 
...
```{python id=zYu3cZheQGSN, colab_type=code, colab={}}
...
```{python id=3o4knBNwu_ac, colab_type=code, colab={}}
